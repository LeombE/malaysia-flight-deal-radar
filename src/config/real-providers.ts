...
export function parseRealProviderConfig(env: Record<string, string | undefined>): RealProviderConfig {
  return {
    ...
    maxRealProviderSearchesPerRun: parsePositiveInteger(env.MAX_REAL_PROVIDER_SEARCHES_PER_RUN, 1),
    maxRealProviderDailyBudget: parsePositiveInteger(env.MAX_REAL_PROVIDER_DAILY_BUDGET, 1),
