...
This roadmap keeps the project honest: the current online demo uses controlled mock fare data. Real-provider activation requires explicit access, retention, rate-limit, display, and revalidation checks.
